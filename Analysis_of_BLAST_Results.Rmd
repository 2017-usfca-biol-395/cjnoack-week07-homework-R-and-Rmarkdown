...
In **Figures 1 and 2**, we see the overall percent identity match for female and male skin samples.
...
The data from the Fierer et al. study are confusing yet interesting. For example, in Figures 1 and 2, we found that the female percent identity match was noticeably much larger than that of males. For females, the identity match was typically above 95%, while in males it was usually 85%. The reason why females have a high percent identity? 
- HYPOTHESIS HERE

To delve further, I examined the top three bacterial species which showed up in females and males, as there wasn't too much overlap. For females, the most common was Bartonella washoensis with 678 matches.   

Table 2: The most common was Solemya pervernicosa gill symbiont with 1,549.
Mismatch, Figure 3: F7 shows the highest rate of mismatches. Noticeably, men have an even spread of very little mismatches, while females show a visible skew to the left. 
